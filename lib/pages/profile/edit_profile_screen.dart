  ...
  Future<void> _dialogBuilder(BuildContext context) {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          content: const Text('Select where You want your picture taken from'),
          actions: <Widget>[
            TextButton(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                onSubmitted: (value) {
                  setState(() {
                    ...
                    widget.data = _nameController?.text ?? "";
                  });
                },
              ),
              const SizedBox(height: 10),
              ...
              TextField(
                ...
                onSubmitted: (value) {
                  setState(() {
                    ...
                    widget.data = _emailController?.text ?? "";
                  });
                },
              ),
              const SizedBox(height: 10),
              ...
              TextField(
                ...
                onSubmitted: (value) {
                  setState(() {
                    ...
                    widget.data = _passwordController?.text ?? "";
                  });
                },
              ),
              const SizedBox(height: 10),
              ...
              Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(6),
                  border: Border.all(width: 1, color: const Color(0x26544C4C)),
                ),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(
